...
public class TransformRotate extends JDialog
{
	private JPanel panelis1, panelis2, panelis3, panelis4;
	private JLabel laibelis1, laibelis2, laibelis3, laibelis4;
	private JTextField tekstas1, tekstas2, tekstas3;
	private JButton gerai, baigti;
	private CanvasPanel canvasPanel;
	private Container mainContainer;
	
	TransformRotate(JFrame parent, CanvasPanel inCanvasPanel)
	{
		super(parent);
		this.setSize(200,200);
		this.setTitle("Posûkis");
		...
		laibelis3 = new JLabel("kampas: ");
		laibelis4 = new JLabel("laipsniai ");
		...
		gerai.addActionListener(
			new ActionListener()
			{
				public void actionPerformed(ActionEvent event)
				{
					...
					canvasPanel.setTransformSeka1(1,1,Double.parseDouble(tekstas3.getText().trim()),
									0,0);
					setVisible(false);	
				}
			}
